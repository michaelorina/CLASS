...
public class axisParser extends Parser {
	...
	public static final int
		RULE_func = 0, RULE_decl = 1, RULE_def = 2, RULE_block = 3, RULE_stat = 4, 
		RULE_expr = 5, RULE_type = 6, RULE_funcHeader = 7, RULE_args = 8, RULE_arg = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"func", "decl", "def", "block", "stat", "expr", "type", "funcHeader", 
			"args", "arg"
		};
	}
	...
	public static class FuncContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof axisListener ) ((axisListener)listener).enterFunc(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof axisListener ) ((axisListener)listener).exitFunc(this);
		}
	}
